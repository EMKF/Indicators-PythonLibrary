...
def shed(series_lst='all', strata=[]):
    """
    Create a pandas data frame with results from a SHED query. 
    Column order: fips, region, time, strata, series_lst.

    Parameters
    ----------
    series_lst: list
        Below is a list of variables that this code fetches and their 
        corresponding question in the original survey. Bullet points give the 
        variable name from the original survey. More complete documentation may
        be found in SHED Codebooks at the following link: 
        https://www.federalreserve.gov/consumerscommunities/shed_data.htm

        Variables: Survey labels
        --------
        man_financially: "Overall, which one of the following best describes how
        well you are managing financially these days?"
            * 2013-2020: 'B2'

        better_off_financially:	"Compared to 12 months ago, would you say that 
        you (and your family) are better off, the same, or worse off 
        financially?"
            * 2013: Missing (different phrasing) |  2014-2020: 'B3'
        
        rainy_day_saving: "Have you set aside emergency or rainy day funds that 
        would cover your expenses for 3 months in case of sickness, job loss, 
        ...
        example, job or government benefits), could you cover your expenses for 
        3 months by borrowing money, using savings, or selling assets?"
            * 2013-2014: 'E1A' | 2015-2020: 'EF2'

        applied_credit: "In the past 12 months, have you (or your spouse/or your 
        partner) applied for any credit (such as a credit card, higher credit 
        card limit, mortgage, refinance, student loan, personal loan, or other 
        loan)?"
            * 2013: 'S12' | 2014-2020: 'A0'

        has_bank_account: "Do you [and/or your spouse / and/or your partner] 
        currently have a checking, savings, or money market account?"
            * 2013: 'S1A' | 2014: 'D7' | 2015-2020: 'BK1'

        rent: "About how much do you pay for rent each month?"
            * 2013: 'R3A' | 2014-2020: 'R3'

        tot_income:	"Which of the following categories best describes the total
        income that you (and your spouse/partner) received from all sources,
        ...
        own_business_retirement: "[Own a business or real estate that will 
        provide income in retirement] Do you currently have each of the 
        following types of retirement savings?"
            * 2013: Missing | 2014: 'K2_g' | 2015-2018: 'K2_f'
                2019-2020: Missing
        
        schedule_variance: "Still thinking about your main job, do you normally 
        start and end work around the same time each day that you work or does 
        it vary?"
        ...
        self_emp_income	: "[Self-employment] In the past 12 months, did you 
        and/or your spouse/partner] receive any income from the following
        sources?"
            * 2013-2014: Missing | 2015-2018: 'I0_b'
                2019-2020: Missing (different phrasing)
